...
详细安装步骤、命令及配置项请参考[虚拟化安装文档](https://docs.openeuler.org/zh/docs/24.03_LTS_SP3/virtualization/virtulization_platform/virtulization/virtualization_installation.html)。
