...
ubs-virt-ovs: ubs-virt提供网络的能力的服务，支持配置指定urma设备的带宽。
ubs-virt-enpu: ubs-virt提供NPU算力切分的服务，支持配置指定的算力和显存资源。
virt-awaresched: virt-awaresched提供对虚拟化调度调优的服务，减少vCPU无意义迁移的性能开销，提升虚机的线性度。

## 使用说明

1. ubs-virt-ovs: [ubs-virt-ovs使用说明](docs/zh/installation/ub_service_core/ubs-virt-ovs_installation.md)
